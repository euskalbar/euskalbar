...
var euskalbar = {
    ...
    startup: function () {
        ...
        AddonManager.getAddonByID(this.guid, function (addon) {
            ...
            if (firstrun) {
                ...
                euskalbar.prefs.setCharPref("installedVersion",
                ...
                try {
                    ...
                    var installedVersion = euskalbar.prefs
    ...
    setUserSkinDisabled: function () {
        ...
        if (!chkSkins.checked) {
            this.prefs.setCharPref("style.combinedquery",
                                   document.getElementById("menuStartupSkin")
                                           .selectedItem.value);
        }
    },
