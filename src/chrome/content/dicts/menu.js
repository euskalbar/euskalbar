...
euskalbar.dicts.menu = [
  { cat: 'euskalbar.menu.General',
    dicts: [
      ...
      { name: 'euskalbar.menu.general.Egungo Euskararen Hiztegia',
  ...
  { cat: 'euskalbar.menu.Encyclopedias',
    dicts: [
      { name: 'euskalbar.menu.encyclopedias.Lur hiztegi entziklopedikoa',
        url: 'http://www.euskara.euskadi.net/r59-lursubhd/eu/contenidos/informacion/lursubhd/eu_lursubhd/lursubhd.html' },
      { name: 'euskalbar.menu.encyclopedias.Lur entziklopedia tematikoa',
  ...
  { cat: 'euskalbar.menu.By Subject',
    dicts: [
      ...
      { name: 'euskalbar.menu.by_subject.Occupational training',
        url: 'http://www.jakinbai.com/lanbideki/hiztegia' },
      { name: 'euskalbar.menu.by_subject.Literature',
  ...
  { cat: 'euskalbar.menu.Corpus',
    dicts: [
      ...
      { name: 'euskalbar.menu.corpus.EHUskaratuak',
        url: 'http://ehuskaratuak.ehu.es' },
      { name: 'euskalbar.menu.corpus.IMemoriak',
